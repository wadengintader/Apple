  ...
  return (
    <>
      ...
      <div className="fixed inset-0 pointer-events-none overflow-hidden opacity-15">
          <Image
            src="https://i.imgur.com/fyWm6al.png"
            alt=""
            width={100}
            height={100}
          ...
          />
          <Image
            src="https://i.imgur.com/u38tBIJ.png"
            alt=""
            width={150}
            height={150}
          ...
          />
          <Image
            src="https://i.imgur.com/o4E8Lbt.png"
            alt=""
            width={160}
            height={160}
          ...
          />
          <Image
            src="https://i.imgur.com/RRMtvNx.png"
            alt=""
            width={160}
            height={160}
          ...
          />
          <Image
            src="https://i.imgur.com/rGMmPLo.png"
            alt=""
            width={160}
            height={160}
          ...
          />
          <Image
            src="https://i.imgur.com/aVxfwBP.png"
            alt=""
            width={80}
            height={80}
